...
export const R1_BLOG_FABRIC = {
  ...
  faqJson: [
    ...
    },
    {
      ...
      answer:
        "TC thường có tỷ lệ polyester cao hơn CVC, thiên bền màu/nhanh khô. CVC nghiêng cotton nhiều hơn. Hỏi rõ tỷ lệ và lấy mẫu thay vì suy diễn từ tên gọi.",
    },
  ],
} as const;
...
export function buildR1FabricHtml(): string {
  ...
  return `
<p>Khi <strong>nhập áo trơn</strong>, chất liệu ảnh hưởng cảm giác mặc, độ bền form sau giặt, khả năng chịu in/thêu và rủi ro tái đơn. Bài viết dành cho xưởng in, đại lý, agency và local brand — chọn giữa <strong>cotton, CVC và polyester</strong> theo brief, không theo jargon catalogue.</p>
<p>Sau khi chọn hướng chất liệu, đối chiếu <a href="${R1_SLUGS.category}">danh mục áo thun trơn</a> và hub <a href="${R1_SLUGS.hub}">áo thun trơn sỉ</a>. Báo giá luôn theo tồn kho và số lượng đơn.</p>
...
<p>TC (polyester cao hơn CVC) thường gần nhóm polyester về hành vi sử dụng. Khi catalogue ghi TC, hỏi rõ tỷ lệ và lấy mẫu.</p>

${r1Figure(img1.url, img1.alt, "Chọn chất liệu trước khi chốt màu/size số lượng lớn.")}
...
<p>Trong catalogue, các dòng như <a href="/san-pham/ao-thun-cotton-100-180gsm">cotton 180gsm</a> và <a href="/san-pham/ao-thun-cotton-100-220gsm">cotton 220gsm</a> giúp so định lượng theo brief — vẫn xác nhận tồn kho trước khi nhập.</p>

${r1Figure(img2.url, img2.alt, "Quan sát mặt vải và đường may trên mẫu thật.")}

<h2>CVC: cân bằng cho đơn lặp</h2>
<p>CVC (thường cotton chiếm tỷ lệ cao hơn polyester) được nhiều xưởng in/đại lý chọn vì giữ form ổn định hơn cotton thuần ở một số ứng dụng, vẫn gần cảm giác cotton.</p>
...
<p>Tham khảo <a href="/san-pham/ao-thun-cvc-65-35">áo thun CVC 65/35</a> và <a href="/vai-cvc-la-gi">vải CVC là gì</a>.</p>
...
<p>Chất liệu chỉ là một biến. Kết hợp với kỹ thuật trang trí: <a href="${R1_SLUGS.article3}">áo trơn cho in lụa, DTF và thêu</a>. Kết hợp với form: <a href="${R1_SLUGS.article4}">regular hay oversize</a>. Checklist chọn nguồn tổng: <a href="${R1_SLUGS.article1}">nguồn áo thun trơn cho xưởng in</a>.</p>
<p>Tái đơn: giữ cùng mã sản phẩm và ghi nhận cảm giác khách cuối sau giặt/in. Đổi chất liệu giữa hai đợt = coi như dự án mẫu mới.</p>

<h2>Checklist trước khi nhập lớn</h2>
<ol>
<li>Viết rõ khách cuối + kỹ thuật chính.</li>
<li>Chọn tối đa 2 chất liệu để lấy mẫu.</li>
<li>Giặt mẫu và thử in/thêu.</li>
<li>Đối chiếu form regular/oversize.</li>
<li>Gửi nhu cầu qua <a href="${R1_SLUGS.contact}">form liên hệ</a> với mã sản phẩm quan tâm.</li>
</ol>
