...
function parseOrderFormBody(raw: Record<string, unknown>): CreateManualOrderInput {
  ...
  return {
    ...
    customerNameSnapshot: parseOptionalString(raw.customerNameSnapshot),
    customerLegalNameSnapshot: parseOptionalString(raw.customerLegalNameSnapshot),
    customerPhoneSnapshot: parseOptionalString(raw.customerPhoneSnapshot),
    customerEmailSnapshot: parseOptionalString(raw.customerEmailSnapshot),
    customerWebsiteSnapshot: parseOptionalString(raw.customerWebsiteSnapshot),
    customerProvinceNameSnapshot: parseOptionalString(raw.customerProvinceNameSnapshot),
    customerWardNameSnapshot: parseOptionalString(raw.customerWardNameSnapshot),
    customerAddressLine1Snapshot: parseOptionalString(raw.customerAddressLine1Snapshot),
    contactName: parseOptionalString(raw.contactName),
    contactTitle: parseOptionalString(raw.contactTitle),
    contactDepartment: parseOptionalString(raw.contactDepartment),
