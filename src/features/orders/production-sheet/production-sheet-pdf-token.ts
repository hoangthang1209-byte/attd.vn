...
export function createProductionSheetPdfToken(orderId: string): string | null {
...
export function verifyProductionSheetPdfToken(token: string, orderId: string): boolean {
  const secret = getAdminSessionSecret();
