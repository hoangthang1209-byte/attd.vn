    ...
    platforms: [
      {
        ...
        items: [
          ...
          { label: "Media Library", href: "/admin/media", status: "active", requiredPermissions: ["canManageCms"] },
  ...
  },
  {
    ...
    platforms: [
      ...
      },
      {
        label: "Growth",
        items: [
          { label: "Campaign", href: "/admin/seo-planning", status: "active", requiredPermissions: ["canManageCms"] },
