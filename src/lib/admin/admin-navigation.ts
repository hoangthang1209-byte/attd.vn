    ...
    platforms: [
      {
        ...
        items: [
          ...
          { label: "Điều hướng và Footer", href: "/admin/site-navigation", status: "active", requiredPermissions: ["canManageCms"] },
          ...
          { label: "Kiểm tra ngữ cảnh AI", href: "/admin/content/ai-retrieval", status: "active", requiredPermissions: ["canManageCms"] },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "KG Relations", href: "/admin/knowledge-graph/relationships", status: "active", requiredPermissions: ["canManageCms"] },
          { label: "KG Evaluation", href: "/admin/knowledge-graph/evaluation", status: "active", requiredPermissions: ["canManageCms"] },
